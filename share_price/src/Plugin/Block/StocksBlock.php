...
/**
 * Provides a Stocks Block.
 *
 * @Block(
 *   id = "stocks_block",
 *   admin_label = @Translation("Stocks block"),
 *   category = @Translation("Stocks block"),
 * )
 */
class StocksBlock extends BlockBase implements ContainerFactoryPluginInterface {
